...
| 優先級 | 方向 | 預估工作量 | 影響範圍 |
|--------|------|-----------|---------|
| ★★★★★ | D3 線索金字塔（改寫現有節點） | 中 | 全遊戲的敘事節奏 |
| ★★★★★ | D2 NPC 互動場景（+8 節點） | 中 | NPC 深度 + 世界活力 |
| ★★★★ | D4② NPC 可能死亡（+3 分支） | 中 | 選擇重量 + 重玩動機 |
| ★★★★ | D1② 石化感官描寫 | 小 | 核心機制的沉浸感 |
| ★★★ | D4① 背叛事件（+2 分支） | 小 | 驚喜 + 因果感 |
| ★★★ | D4④ 世界觀顛覆 | 小 | 為 R4 鋪路 |
| ★★★ | D1① 環境微敘事 | 小 | 巡邏體驗提升 |
| ★★ | D4③ 隱藏 Boss（+3 Boss） | 中 | NG+ 探索獎勵 |
| ★★ | D3 線索追蹤 UI | 小 | QoL 改善 |
| ★ | D1③ 時間感/疲勞感 | 小 | 錦上添花 |
