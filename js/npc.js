...
var CONSUMABLE_DATA = {
  ...
  'First Aid Herbs': { hp: 15, label: 'HP +15' },
  '新鮮草藥':     { hp: 15, petri: -5, label: 'HP +15, 石化 -5%', labelEn: 'HP +15, Petri -5%' },
  'Fresh Herbs':  { hp: 15, petri: -5, label: 'HP +15, Petri -5%' },
  'HP 藥水':      { hp: 15, label: 'HP +15' },
  'HP Potion':    { hp: 15, label: 'HP +15' },
  '濃縮藥水':     { hp: 25, label: 'HP +25' },
  'Concentrated Potion': { hp: 25, label: 'HP +25' },
  '淨化液':       { petri: -10, label: '石化 -10%', labelEn: 'Petri -10%' },
  'Purifier':     { petri: -10, label: 'Petri -10%' },
  '蘋果':         { hp: 5, label: 'HP +5' },
  'Apple':        { hp: 5, label: 'HP +5' },
