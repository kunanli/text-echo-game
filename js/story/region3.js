...
registerNode('r3_bell', () => {
  ...
  if (!state.flags.r3BellMet) {
    ...
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '她的視線從你的臉開始，慢慢滑到你的肩膀、胸口、腰線——然後又回到你的眼睛。那種打量的方式不像是在評估一個人的戰鬥力，更像是一隻貓在審視獵物，判斷值不值得玩弄。', textEn: 'Her gaze starts at your face, slides slowly down your shoulders, chest, waistline — then back to your eyes. The way she looks at you isn\'t assessing combat potential. It\'s more like a cat appraising prey, deciding if you\'re worth toying with.', delay: 3500 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '她嘴角微微上揚了一瞬——那個弧度太快了，快到你幾乎以為自己看錯了。但你沒有看錯。那是一個飽含深意的、飢餓的微笑。', textEn: 'The corner of her mouth twitches upward for just an instant — so fast you almost think you imagined it. But you didn\'t. It was a meaningful, hungry smile.', delay: 3000 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '「嗯——」她的聲音低沉得像在喉嚨裡滾了一圈，帶著某種你無法定義的滿意。「比我想像的……完整。從那麼深的地方爬上來，居然還有這樣的體格。」她的琥珀色眼睛裡有種明亮的、捕食者般的光。', textEn: '"Hmm —" Her voice rolls low in her throat, carrying an undefined satisfaction. "More... intact than I expected. To have climbed from such depths and still have a frame like that." Her amber eyes hold a bright, predatory gleam.', delay: 3800 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '她站起身走近你——你本能地想後退半步，但她的氣場把你釘在了原地。她比你高半個頭。她低下頭看你的時候，你聞到了她身上淡淡的墨水和茶葉氣味——還有某種更溫暖的、屬於她自己的體溫。', textEn: 'She stands and walks toward you — instinct screams to step back, but her presence pins you in place. She\'s half a head taller. As she looks down at you, you catch the scent of ink and tea — and something warmer, something that\'s simply her.', delay: 3800 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '她伸出左手，指尖輕輕抬起你的下巴，像在察看一件器物的成色。她的手指冰涼而有力，拇指擦過你的下顎線。近距離下你才發現她的睫毛很長，琥珀色的虹膜裡有細小的金色碎片。', textEn: 'She reaches out with her left hand, fingertips tilting your chin up — inspecting you like a craftsman examining fine material. Her fingers are cool and firm, thumb brushing your jawline. Up close, you notice long lashes, and tiny golden flecks within her amber irises.', delay: 3800 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '「……不錯。」她鬆開手，退回去半步——但那半步的距離依然近得不合常理。她的目光裡多了一些東西。不是審視，是興趣。一種很危險的興趣。', textEn: '"...Not bad." She lets go and half-steps back — but that half-step still leaves her unreasonably close. Something new in her gaze. Not appraisal anymore. Interest. A dangerous kind of interest.', delay: 3500 });
    steps.push({ tag: '感知', tagColor: 'tag-sense', text: '她的目光停在你身上的石化痕跡上。這次的表情變了——飢餓的光芒消退，取而代之的是某種沉重的、感同身受的理解。她不自覺地用左手按了按自己石化的右手腕。', textEn: 'Her gaze finds your petrification marks. Her expression shifts — the hungry gleam fades, replaced by a heavy, empathetic understanding. She unconsciously presses her left hand against her own petrified right wrist.', delay: 3500 });
    steps.push({ tag: '情報', tagColor: 'tag-info', text: '「下面的情況怎麼樣？還有多少人活著？」她的語氣不是在詢問——更像是在下達命令要求你回報。但她看你的眼神，和剛才審視你身體時一樣專注。', textEn: '"How are things below? How many are still alive?" Her tone isn\'t a question — it\'s closer to an order demanding a report. But the way she watches you is just as intent as when she was surveying your body.', delay: 2800 });
  } else {
    steps.push({ tag: '移動', tagColor: 'tag-move', text: '銅鐘還是坐在那張堆滿文件的桌子旁。看到你來，她放下筆，身子微微後靠——嘴角勾起一個幾乎不可察覺的弧度。', textEn: 'Bronze Bell sits at her document-laden desk. Seeing you, she puts down her pen and leans back — the faintest curve touching the corner of her mouth.', delay: 2500 });
    steps.push({ tag: '情報', tagColor: 'tag-info', text: '「有什麼進展？」她的目光從你的頭頂慢慢掃到腳底，然後又沿著相同的路徑回來，最後停在你的眼睛上。那種打量的方式讓你覺得自己的衣服少穿了一層。', textEn: '"Any progress?" Her gaze trails slowly from the top of your head to the tips of your boots, then retraces the same path back up, settling on your eyes. The way she looks at you makes you feel a layer of clothing lighter.', delay: 2800 });
  }
